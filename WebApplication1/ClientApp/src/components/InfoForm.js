...
class InfoForm extends Component {
    ...
    change =(r1,r2,name)=>
    {
        ...
        switch (name) {
            case 'Место проживания' :  if(r1) this.setState({wher: true}); else this.setState({wher: false});  break;
            case 'Работаете?' : if(r1) this.setState({work: true}); else this.setState({whork: false}); break;
            case 'Пол' :    if(r1) this.setState({sex: true}); else this.setState({sex: false});  break;
        }
    }
